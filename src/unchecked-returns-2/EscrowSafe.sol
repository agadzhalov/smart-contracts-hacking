 ...
 */
contract EscrowSafe is Ownable {
    ...
    function redeemEthFromEscrow(uint256 _tokenId) external {
        ...
        require(success, "burn wasn't successfull");

        (bool successEth, ) = payable(msg.sender).call{value: amount}("");
        require(successEth, "unsuccessful transfer");
